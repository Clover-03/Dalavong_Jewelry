<template>
  <ModernPageLayout 
    title="ລາຍງານການນຳສົ່ງສິນຄ້າ"
    subtitle="ສະຫຼຸບແລະວິເຄາະການນຳສົ່ງສິນຄ້າທັງໝົດໃນລະບົບ"
    ...
    <div class="summary-section mb-6">
      <v-row>
        <v-col cols="12" md="3">
          <div class="stat-card">
            <div class="stat-icon">
              <v-icon size="32" color="#365a76">mdi-truck-delivery</v-icon>
            </div>
            <div class="stat-content">
              <h3 class="stat-number">{{ totalDeliveries }}</h3>
              <p class="stat-label">ການນຳສົ່ງທັງໝົດ</p>
            </div>
          </div>
        </v-col>
        <v-col cols="12" md="3">
          <div class="stat-card">
            ...
            <div class="stat-content">
              <h3 class="stat-number">{{ completedDeliveries }}</h3>
        ...
        <v-col cols="12" md="3">
          <div class="stat-card">
            ...
            <div class="stat-content">
              <h3 class="stat-number">{{ pendingDeliveries }}</h3>
